...
We will also need a base map with the data, which may be downloaded at [this link](https://github.com/BjnNowak/TidyTuesday/raw/main/map/sport/france_sport.gpkg) or loaded directy in R as shown below:

```{r}
map<-sf::read_sf('https://github.com/BjnNowak/TidyTuesday/raw/main/map/sport/france_sport.gpkg')
```
